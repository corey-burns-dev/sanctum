...
const mockPosts = [
  {
    ...
    content: 'Just shipped a new feature! 🚀 The new dark mode toggle is working perfectly. Loving the new Tailwind v4 setup.',
  ...
  },
  {
    ...
    author: 'bob_coder',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=bob',
    content: 'Working on some Go backend optimizations. Fiber v2 is amazing for performance! The Redis integration is smooth.',
  ...
  },
  {
    ...
    author: 'charlie_ui',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=charlie',
    content: 'The new shadcn/ui components are incredible. Building this chat interface was so much easier with the scroll area and inputs.',
    likes: 67,
    comments: [
      {
        id: 4,
