            ...
            <div className="w-full max-w-md space-y-8">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-muted-foreground">
                        Start a video call with friends — peer-to-peer, no servers in the middle.
                    </p>
                </div>
                ...
                <div className="bg-card border border-border rounded-xl p-6 space-y-4">
                    ...
                    {generatedRoom ? (
                        ...
                        <Button className="w-full" variant="outline" onClick={generateRoomId}>
                            Generate Room ID
                        </Button>
                    )}
                </div>
...
function ActiveCall({ roomId, onLeave }: { roomId: string; onLeave: () => void }) {
